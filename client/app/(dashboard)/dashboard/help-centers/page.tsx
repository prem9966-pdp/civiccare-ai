           ...
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                 <h1 className="text-4xl font-black text-primary tracking-tighter italic flex items-center gap-3">
                   Help Centers <span className="text-accent underline decoration-accent/20">Explorer</span>
              ...
              <div className="flex items-center gap-2">
                 <button 
                   ...
                   className="inline-flex items-center justify-center rounded-2xl h-12 px-6 border border-slate-200 font-bold text-xs uppercase tracking-widest hover:bg-slate-50 gap-2 transition-colors"
                 >
                   <Compass className="h-4 w-4" /> Use My Location
                 </button>
                 <button 
                   onClick={() => fetchHospitals(filters)}
                   className="inline-flex items-center justify-center rounded-2xl h-12 w-12 p-0 border border-slate-200 hover:bg-slate-50 transition-colors"
                 >
